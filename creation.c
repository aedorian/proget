...
void creer_tous_objets(game* game) {
  ...
  ajouter_balle_obj(game, new_balle(new_vect(12, 12), 2, 10, 1, B_VACHE)); /* 1 */
  ajouter_balle_obj(game, new_balle(new_vect(9, 9), 2, 10, 1, B_VACHE)); /* 2 */
  ...
  ajouter_balle_obj(game, new_balle(new_vect(9, 9), 2, 10, 1, B_VACHE)); /* 4 */
    ...
    ajouter_balle_obj(game, new_balle(new_vect(12, 12), 2, 3, 0, B_COQ)); /* 13 : coq */
    ...
    ajouter_arme_obj(game, new_arme(game -> balles_obj[0], DOUBLE, 11)); /* 2 : double tir */
    ...
    ajouter_ennemi_obj(game, /* 7 : coq */
		       new_ennemi(new_vect(24, 30), 3, 10, game -> armes_obj[13], COQ));
