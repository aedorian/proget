...
prod: affichage.o evenement.o mouvement.o creation.o gamemanager.o main.o collision.o menu.o
	gcc -W -Wall -std=c89 -pedantic -O2 -o prod main.o affichage.o evenement.o mouvement.o collision.o creation.o gamemanager.o menu.o `pkg-config --cflags MLV` `pkg-config --libs-only-other --libs-only-L MLV` `pkg-config --libs-only-l MLV`
